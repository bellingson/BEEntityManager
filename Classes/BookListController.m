...
- (void)viewWillAppear:(BOOL)animated {
	...
	BEEntityManager *entityManager = [[BEEntityManager alloc] init];
	self.rowData = [entityManager query:@"Book" criteria: @"ID != nil" sort: nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	Book *book = [rowData objectAtIndex: indexPath.row];
